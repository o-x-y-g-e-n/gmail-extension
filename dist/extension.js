    ...
    */
    ...
    api.helper.get.email_data_pre = function(email_id) {
        ...
        if(email_id !== undefined) {
            url = window.location.origin + window.location.pathname + '?ui=2&ik=' + api.tracker.ik + '&rid=' + api.tracker.rid + '&view=cv&th=' + email_id + '&msgs=' + email_id + '&mb=0&rt=1&search=mbox';        }
        return url;
    };
...
gmail.observe.on("open_email", function(id, url, body, xhr) {
   gmail.get.email_data_async(id,function(emaildata){
         var x = gmail.get.email_id();
         // this is the variable that is storing the text --> myans
         var myans = emaildata["threads"][x]["content_plain"];
         console.log(myans);
    })
})
